/**
 * LiveFeed — Collapsible floating live event feed overlay for the threat map.
 */
    ...
    <div className="absolute top-3 right-3 w-[260px] z-10">
      <div className="bg-card/70 backdrop-blur-md border border-border/50 rounded-lg overflow-hidden">
        <button
          ...
          className="w-full px-3 py-1.5 border-b border-border/30 flex items-center justify-between hover:bg-accent/10 transition-colors"
        >
