...
export const EditSourceDialog = React.forwardRef<HTMLDivElement, Props>(
  ({ open, onOpenChange, name, onNameChange, description, onDescriptionChange, url, onUrlChange, interval, onIntervalChange, onSave, saving }, ref) => {
    return (
